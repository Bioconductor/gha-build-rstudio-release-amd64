...
Content type 'application/x-gzip' length 30499 bytes (29 KB)
==================================================
downloaded 29 KB

trying URL 'https://cloud.r-project.org/src/contrib/rjsoncons_1.2.0.tar.gz'
...
** testing if installed package keeps a record of temporary installation path
* creating tarball
packaged installation of ‘rjsoncons’ as ‘rjsoncons_1.2.0_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (rjsoncons)
...
The downloaded source packages are in
	‘/tmp/RtmpdAmPqm/downloaded_packages’

...
trying URL 'https://p3m.dev/cran/__linux__/jammy/latest/src/contrib/rjsoncons_1.3.1.tar.gz'
Content type 'binary/octet-stream' length 1497952 bytes (1.4 MB)
==================================================
downloaded 1.4 MB
...
* creating tarball
packaged installation of ‘rjsoncons’ as ‘rjsoncons_1.3.1_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (rjsoncons)
...
The downloaded source packages are in
	‘/tmp/Rtmp09AI2g/downloaded_packages’

...
trying URL 'https://bioconductor.org/packages/3.19/bioc/src/contrib/BiocBaseUtils_1.5.0.tar.gz'
Content type 'application/x-gzip' length 226210 bytes (220 KB)
==================================================
downloaded 220 KB
...
trying URL 'https://bioconductor.org/packages/3.19/bioc/src/contrib/UniProt.ws_2.43.0.tar.gz'
Content type 'application/x-gzip' length 241946 bytes (236 KB)
==================================================
downloaded 236 KB
...
* creating tarball
packaged installation of ‘BiocBaseUtils’ as ‘BiocBaseUtils_1.5.0_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (BiocBaseUtils)
...
g++ -std=gnu++17 -I"/usr/local/lib/R/include" -DNDEBUG -I../inst/include/ -I'/usr/local/lib/R/site-library/cpp11/include' -I/usr/local/include    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c cpp11.cpp -o cpp11.o
g++ -std=gnu++17 -I"/usr/local/lib/R/include" -DNDEBUG -I../inst/include/ -I'/usr/local/lib/R/site-library/cpp11/include' -I/usr/local/include    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c rjsoncons.cpp -o rjsoncons.o
g++ -std=gnu++17 -shared -L/usr/local/lib/R/lib -L/usr/local/lib -o rjsoncons.so cpp11.o rjsoncons.o -L/usr/local/lib/R/lib -lR
...
** testing if installed package keeps a record of temporary installation path
* creating tarball
packaged installation of ‘UniProt.ws’ as ‘UniProt.ws_2.43.0_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (UniProt.ws)

The downloaded source packages are in
	‘/tmp/RtmpE74nRz/downloaded_packages’

...
trying URL 'https://bioconductor.org/packages/3.19/bioc/src/contrib/gemma.R_3.0.7.tar.gz'
Content type 'application/x-gzip' length 2059774 bytes (2.0 MB)
==================================================
downloaded 2.0 MB
...
* creating tarball
packaged installation of ‘gemma.R’ as ‘gemma.R_3.0.7_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (gemma.R)
...
The downloaded source packages are in
	‘/tmp/RtmpBuXe2n/downloaded_packages’

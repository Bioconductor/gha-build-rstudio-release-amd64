...
trying URL 'https://bioconductor.org/packages/3.19/bioc/src/contrib/gemma.R_3.0.8.tar.gz'
Content type 'application/x-gzip' length 2061574 bytes (2.0 MB)
==================================================
downloaded 2.0 MB
...
* creating tarball
packaged installation of ‘gemma.R’ as ‘gemma.R_3.0.8_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (gemma.R)
...
The downloaded source packages are in
	‘/tmp/RtmpUSJRiy/downloaded_packages’
